...
DECLARE_INTERFACE_(IDirectInput8A, IUnknown)
{
    ...
    STDMETHOD(ConfigureDevices)(
        THIS_ LPDICONFIGUREDEVICESCALLBACK lpdiCallback, LPDICONFIGUREDEVICESPARAMSA lpdiCDParams, DWORD dwFlags, LPVOID pvRefData) PURE;
};
...
DECLARE_INTERFACE_(IDirectInput8W, IUnknown)
{
    ...
    STDMETHOD(ConfigureDevices)(
        THIS_ LPDICONFIGUREDEVICESCALLBACK lpdiCallback, LPDICONFIGUREDEVICESPARAMSW lpdiCDParams, DWORD dwFlags, LPVOID pvRefData) PURE;
};
#undef INTERFACE
