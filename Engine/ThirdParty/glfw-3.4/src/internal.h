...
#if defined(GLFW_INCLUDE_GLCOREARB) || defined(GLFW_INCLUDE_ES1) || defined(GLFW_INCLUDE_ES2) || defined(GLFW_INCLUDE_ES3) || \
    defined(GLFW_INCLUDE_ES31) || defined(GLFW_INCLUDE_ES32) || defined(GLFW_INCLUDE_NONE) || defined(GLFW_INCLUDE_GLEXT) ||  \
    defined(GLFW_INCLUDE_GLU) || defined(GLFW_INCLUDE_VULKAN) || defined(GLFW_DLL)
...
GLFWbool _glfwChooseVisualEGL(
    const _GLFWwndconfig* wndconfig, const _GLFWctxconfig* ctxconfig, const _GLFWfbconfig* fbconfig, Visual** visual, int* depth);
#endif /*_GLFW_X11*/
