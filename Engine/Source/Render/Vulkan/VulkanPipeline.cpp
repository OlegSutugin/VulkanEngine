...
DEFINE_LOG_CATEGORY_STATIC(VulkanPipelineLog)
DEFINE_LOG_CATEGORY_STATIC(VulkanPipelineDebugLog)
...
void VulkanRenderer::CreateRenderPass(WindowRenderContext& context)
{
    ...
    {
        VE_LOG(VulkanPipelineLog, Error, "Failed to create render pass");
    }
}
...
void VulkanRenderer::CreateGraphicsPipeline(WindowRenderContext& context)
{
    ...
    {
        VE_LOG(VulkanPipelineLog, Error, "Failed to create pipeline layout");
    }
    ...
    {
        VE_LOG(VulkanPipelineLog, Error, "Failed to create graphics pipeline");
    }
...
VkShaderModule VulkanRenderer::CreateShaderModule(const std::vector<char>& code) const
{
    ...
    {
        VE_LOG(VulkanPipelineLog, Error, "Failed to create shader module");
...
std::vector<char> VulkanRenderer::ReadFile(const std::string& filename)
{
    ...
    if (!file.is_open())
    {
        VE_LOG(VulkanPipelineLog, Error, "Failed to open file: {}", filename);
        return {};
    }
